<div class="d-flex justify-content-between align-items-center mb-4">
  <h4 class="mb-0">Passagem <?= h($sol['codigo']) ?></h4>
...
<div class="row g-4">
  <div class="col-md-8">
    <div class="card card-dashboard p-4 mb-4">
      <h6 class="text-muted">QUEM PASSOU</h6>
      ...
      <h6 class="text-muted">QUEM RECEBEU</h6>
      <p class="mb-3"><?= h($passagem['recebeu_nome']) ?> — matrícula <?= h($passagem['recebeu_matricula']) ?> — <?= h($passagem['recebeu_setor_nome']) ?></p>

      <h6 class="text-muted">PLANTÃO</h6>
      <p class="mb-3"><?= formatarData($passagem['data']) ?> das <?= formatarHora($passagem['hora_inicial']) ?> às <?= formatarHora($passagem['hora_final']) ?> — turno <?= h($passagem['turno']) ?></p>
    ...
    <div class="card card-dashboard p-4 mb-4 border-primary">
      <h6>Você recebeu esta solicitação de passagem. Deseja aceitar?</h6>
